...
function createGalleryImage({ original, preview, description }) {
  return `
...
const galleryCardsSet = galleryItems.map(createGalleryImage).join("");

galleryList.insertAdjacentHTML("beforeend", galleryCardsSet);
galleryList.addEventListener("click", selectGalleryImage);